...
import { CollectionView, Event, EventArgs, CancelEventArgs, PageChangingEventArgs, CollectionViewGroup, Aggregate } from '@mescius/wijmo';
/**
...
export declare class RestCollectionView extends CollectionView {
    ...
    _end: number;
    _firstLoad: boolean;
    _expandedGroups: CollectionViewGroup[];
    _groupItems: any[];
    _data: any[];
    _loadOffset: number;
    _toSetWindow: any;
    ...
    _refresh: boolean;
    _requestCanceled: Event<RestCollectionView, EventArgs>;
    /**
    ...
    *
    */
    lazyLoadGroup(item: CollectionViewGroup): void;
    /**
     ...
     */
    getGroupAggregate(columnBinding: string, groupItem: CollectionViewGroup, aggregate?: Aggregate): any;
    /**
    ...
    _updateExpandedGroups(item: CollectionViewGroup, isCollapsed: boolean): void;
    ...
    readonly requestCanceled: Event<RestCollectionView, EventArgs>;
    /**
     ...
     */
    protected getItems(item?: string | CollectionViewGroup): Promise<any[]>;
    /**
