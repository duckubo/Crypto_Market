...
export declare type MultiRowInputs = wjGrid.FlexGridInputs & {
    ...
    recordViewRange?: wjcGrid.CellRange;
    showHeaderCollapseButton?: boolean;
};
export declare type MultiRowEvents<T> = wjGrid.FlexGridEvents<T> & {
    collapsedHeadersChanged?: wjcCore.IEventHandler<T, wjcCore.EventArgs>;
    collapsedHeadersChanging?: wjcCore.IEventHandler<T, wjcCore.CancelEventArgs>;
};
export declare const MultiRowMeta: {
    inputs: string[];
    events: string[];
};
export declare type MultiRowProps = MultiRowInputs & MultiRowEvents<wjcGridMultirow.MultiRow>;
export declare type MultiRowRef = WjRef<wjcGridMultirow.MultiRow>;
/**
 ...
 */
export declare const MultiRow: React.ForwardRefExoticComponent<MultiRowProps>;
export declare type MultiRowCellInputs = wjGrid.FlexGridColumnInputs & {
    col?: number;
    colspan?: number;
    row?: number;
    rowspan?: number;
...
export declare type MultiRowCellEvents<T> = wjGrid.FlexGridColumnEvents<T> & {};
export declare const MultiRowCellMeta: {
    inputs: string[];
    events: string[];
};
export declare type MultiRowCellProps = MultiRowCellInputs & MultiRowCellEvents<wjcGridMultirow.MultiRowCell>;
export declare type MultiRowCellRef = WjRef<wjcGridMultirow.MultiRowCell>;
/**
 ...
 * The signature of the handler function is the same as any other Wijmo event handlers.
 */
export declare const MultiRowCell: React.ForwardRefExoticComponent<MultiRowCellProps>;
export declare type MultiRowCellGroupInputs = MultiRowCellInputs & {};
export declare type MultiRowCellGroupEvents<T> = MultiRowCellEvents<T> & {};
export declare const MultiRowCellGroupMeta: {
    inputs: string[];
    events: string[];
};
export declare type MultiRowCellGroupProps = MultiRowCellGroupInputs & MultiRowCellGroupEvents<wjcGridMultirow.MultiRowCellGroup>;
export declare type MultiRowCellGroupRef = WjRef<wjcGridMultirow.MultiRowCellGroup>;
/**
 ...
 * The signature of the handler function is the same as any other Wijmo event handlers.
 */
export declare const MultiRowCellGroup: React.ForwardRefExoticComponent<MultiRowCellGroupProps>;
export declare type MultiRowCellTemplateInputs = wjGrid.FlexGridCellTemplateInputs & {
    template?: MultiRowCellTemplateRender;
};
export declare type MultiRowCellTemplateEvents<T> = wjGrid.FlexGridCellTemplateEvents<T> & {};
export declare const MultiRowCellTemplateMeta: {
    inputs: string[];
    events: any[];
};
export declare type MultiRowCellTemplateProps = MultiRowCellTemplateInputs & MultiRowCellTemplateEvents<ReactMultiRowCellTemplate>;
export declare type MultiRowCellTemplateRef = WjRef<ReactMultiRowCellTemplate>;
/**
 ...
 * ```
 */
export declare const MultiRowCellTemplate: React.ForwardRefExoticComponent<MultiRowCellTemplateProps>;
export declare class ReactMultiRowCellTemplate extends wjGrid.ReactFlexGridCellTemplate {
}
export interface IMultiRowCellTemplateContext extends wjGrid.ICellTemplateContext {
    col: wjcGridMultirow.MultiRowCell;
    row: wjcGridMultirow._MultiRow | wjcGridMultirow._MultiGroupRow;
}
