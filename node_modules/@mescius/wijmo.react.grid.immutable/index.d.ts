...
export declare type ImmutabilityProviderInputs = BaseInputs & {
    itemsSource?: any;
};
export declare type ImmutabilityProviderEvents<T> = {
    cloningItem?: wjcCore.IEventHandler<T, wjcGridImmutable.CloningItemEventArgs>;
    dataChanged?: wjcCore.IEventHandler<T, wjcGridImmutable.DataChangeEventArgs>;
};
export declare const ImmutabilityProviderMeta: {
    inputs: string[];
    events: string[];
};
export declare type ImmutabilityProviderProps = ImmutabilityProviderInputs & ImmutabilityProviderEvents<wjcGridImmutable.ImmutabilityProvider>;
export declare type ImmutabilityProviderRef = WjRef<wjcGridImmutable.ImmutabilityProvider>;
/**
 ...
 * ```
 */
export declare const ImmutabilityProvider: React.ForwardRefExoticComponent<ImmutabilityProviderProps>;
